...
gravater = Gravatar(app, size=100,
                    rating='g',
                    default='retro',
                    force_default=False,
                    force_lower=False,
...
@app.route("/contact")
def contact():
    return render_template("contact.html", lcurrent_user=current_user)
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", form=edit_form, lcurrent_user=current_user)
